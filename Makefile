...
ifeq ($(ENABLE_MESSENGER_UART),1)
	CCFLAGS += -DENABLE_MESSENGER_UART
endif
ifeq ($(ENABLE_MESSENGER_NOTIFICATION),1)
	CCFLAGS += -DENABLE_MESSENGER_NOTIFICATION
endif
ifeq ($(ENABLE_MESSENGER_DELIVERY_NOTIFICATION),1)
	CCFLAGS += -DENABLE_MESSENGER_DELIVERY_NOTIFICATION
endif
...
ifeq ($(ENABLE_FEAT_F4HWN),1)
	...
	CCFLAGS  += -DAUTHOR_STRING_1=\"$(AUTHOR_STRING_2)\" -DVERSION_STRING_1=\"$(VERSION_STRING_2)\"
	CCFLAGS  += -DAUTHOR_STRING_2=\"$(AUTHOR_STRING)\" -DVERSION_STRING_2=\"$(VERSION_STRING)\"
...
CCFLAGS  += -DU8G2_NO_BALANCED_STR_WIDTH_CALCULATION
CCFLAGS  += -DU8G2_WITHOUT_UNICODE
CCFLAGS  += -DU8G2_WITHOUT_FONT_ROTATION
